{
  ...
  src = fetchFromGitHub {
    owner = "pipeweaver";
    repo = "pipeweaver";
    rev = "d902f16db21f2f8f7c286a53032a4c3d6e00a7c9";
    hash = "sha256-C/9H/bEx51ck3UntHI1f3HInWO/dF8dBkWghrhYEJxg=";
  };
  ...
  web = buildNpmPackage {
    ...
    npmDepsHash = "sha256-9GJh/WSOph7nN2KIIEwhh3fHppu+WTr2Yl78t5BLM30=";
...
in
  rustPlatform.buildRustPackage (finalAttrs: {
    ...
    cargoHash = "sha256-4YNJHE5Kny9c7bQcwCed6o3DexIBXIBvxhPjckgPOGI=";
